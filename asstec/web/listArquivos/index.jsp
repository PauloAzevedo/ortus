        ...
        <div id="pagina">
            ...
            <div id="conteudo">  
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="listagem">
                    ...
                    <c:forEach var="arquivo" items="${listaArquivos}" varStatus="status">                         
                        <tr>
                            <td>${arquivo.getId()}</td>
                            <td>${arquivo.getNome()}</td>  
                            <td><a href="${arquivo.getArquivo().getPath()}"><img id="imagem" src="../imagens/pagina/pdf.png" /></a></td>  
                            <td>${arquivo.getTipo().getTipo()}</td>  
                        </tr>

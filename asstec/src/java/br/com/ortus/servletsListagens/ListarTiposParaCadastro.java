 ...
 */
@WebServlet(name = "ListarTiposParaCadastro", urlPatterns = {"/ListarTiposParaCadastro"})
public class ListarTiposParaCadastro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             List listaTipos = new DaoTipo().listar();
...
//            System.out.println(user.getPapel().getNome());
            ...
            if(!listaTipos.isEmpty()){
                ...
                response.sendRedirect("cadArquivo/");
            }
        } finally {            
            out.close();
        }

 ...
 * @author Usuario
 */
public class JDialogMoldeComponente extends javax.swing.JDialog {

    private Componente componenteAux;

    /** Creates new form JDialogMoldeComponente */
    public JDialogMoldeComponente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(10, 10, 10)
                                .addComponent(jTextFieldNomeComponente)))
                        .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogMoldeComponente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                JDialogMoldeComponente dialog = new JDialogMoldeComponente(new javax.swing.JFrame(), true);
    ...
    private void salvar() {
        if (componenteAux != null) {
            if (jTextFieldNumeroSerie.getText().isEmpty()) {
                ...
                md.setNumeroIdentificacao(jTextFieldNumeroSerie.getText());

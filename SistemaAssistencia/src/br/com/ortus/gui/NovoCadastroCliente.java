 ...
 */
public class NovoCadastroCliente extends javax.swing.JDialog {
    ...
    public NovoCadastroCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTabbedPaneCliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabbedPaneClienteMouseClicked(evt);
            }
        });
        ...
        jPanelEndereco.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Endereço", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 10))); // NOI18N
    ...
    private void jTabbedPaneClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPaneClienteMouseClicked
        // TODO add your handling code here:
        povoarTabelaClientes();
    }//GEN-LAST:event_jTabbedPaneClienteMouseClicked
    ...
    private void povoarTabelaClientes() {
        ...
        if (clientes != null) {
            ...
            definirTamanhoDasColunas(jTableClientes);
        }
...
//                pesquisarPorValorMenorIgual();
    ...
    private void adicionarNaAsstec() {        
        Cliente c = new ClienteDao().obterPorId(Integer.parseInt(jTextFieldID.getText()));
        if(c!= null){
    ...
    private void adicionarNaAsstec(Cliente cliente) {        
        if(cliente!= null){
            HashSistema.hash.put("cliente", cliente);
            dispose();
        }else{
            JOptionPane.showMessageDialog(null, "Erro na transferencia.");
            return;
        }
    }
}

...
public abstract class Conexao {
    ...
    public static Connection getConnection() throws SQLException {
        String conecaoMysql = "jdbc:mysql://" + HibernateConfiguracao.getHost() + "/?user=" + HibernateConfiguracao.getUsuarioBase()
                + "&password=" + HibernateConfiguracao.getSenhaBase();
        if (conexao == null) {
    ...
    public static Connection getConnectionJasper() throws SQLException {
        ...
        String conecaoMysql = "jdbc:mysql://" + HibernateConfiguracao.getHost() + "/" + HibernateConfiguracao.getBaseDados()
                + "?user=" + HibernateConfiguracao.getUsuarioBase()+ "&password=" + HibernateConfiguracao.getSenhaBase();

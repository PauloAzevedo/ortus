...
CREATE TABLE `assistencia` (
  ...
  CONSTRAINT `FK504A0689122F20C5` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`)
...
CREATE TABLE `assistencia_equipamento` (
  ...
  UNIQUE KEY `equipamentos_id` (`equipamentos_id`),
...
CREATE TABLE `assistencia_moldecomponente` (
  ...
  UNIQUE KEY `moldeComponentes_id` (`moldeComponentes_id`),
...
INSERT INTO `componente` (`id`,`nome`,`qtde`,`unidadeMedida`,`valor`,`usuario_id`) VALUES 
 ...
 (1544,'CHAVE 1X2 L/D2 TERM SOLDA (Liga/Desliga)',5,'UND',7,1),
 (1628,'CHAVE 1X2 L/L3 TERM SOLDA (Liga/Liga)',10,'UND',10,1),
 ...
 (1903,'CAIXA DE PAPELÃO ORTUSONIC CRISTOFOLI',5,'UND',15,1),
 ...
 (2034,'AIR PUMP AJK-B2701 (MICRO BOMBA DE AR)',5,'UND',51,1),
 ...
 (2211,'	CE ULTRASOM SONI II / BIOSCALER	',0,'	CJ	',145,1),
 (2212,'	VÁLVULA SOLENÓIDE EMICOL	',0,'	CJ	',63,1),
...
INSERT INTO `usuario` (`id`,`dataCadastro`,`login`,`nome`,`senha`,`tipo`) VALUES 
 (1,'2012-01-26','admin','admin','123456',' Administrador'),
 (2,'2012-01-27','paulocompras','Paulo Sergio','123456','Usuário');
